...
from harl.algorithms.actors.nonadaptive_wasserstein import WMATRPO_NONADAPTIVE       #WIP - To be Added; Nothing is defined there for now; Please check this
...
#    "adaptive_wasserstein": ?,                 #WIP - To be Added; Nothing is defined there for now; Please check this
    "nonadaptive_wasserstein": WMATRPO_NONADAPTIVE,              #WIP - To be Added; Nothing is defined there for now; Please check this
    "WMATRPO_NONADAPTIVE": WMATRPO_NONADAPTIVE,
    "haa2c": HAA2C,
    "haddpg": HADDPG,
    "hatd3": HATD3,
    "hasac": HASAC,
